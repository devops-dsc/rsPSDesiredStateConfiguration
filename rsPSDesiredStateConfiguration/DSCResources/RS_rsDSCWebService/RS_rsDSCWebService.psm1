...
function Set-TargetResource
{
    ...
    $webConfigFileName = "$pathPullServer\web.config"
    ...
    Write-Verbose "Create the IIS endpoint"
        rsPSDesiredStateConfiguration\New-PSWSEndpoint -site $EndpointName `
                     -path $PhysicalPath `
                     ...
                     -dependentBinaries  "$pathPullServer\bin\Microsoft.Powershell.DesiredStateConfiguration.Service.dll" `
                     -language $language `
                     -dependentMUIFiles  "C:\Windows\System32\WindowsPowerShell\v1.0\Modules\PSDesiredStateConfiguration\PullServer\en\Microsoft.Powershell.DesiredStateConfiguration.Service.Resources.dll" `
                     -certificateThumbPrint $CertificateThumbPrint `
